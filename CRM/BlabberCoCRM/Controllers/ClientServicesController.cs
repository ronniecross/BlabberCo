...
namespace BlabberCoCRM.Controllers
{
    public class ClientServicesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,StartDate,EndDate")] ClientService clientService)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,StartDate,EndDate")] ClientService clientService)
        {
